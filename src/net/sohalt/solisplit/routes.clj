...
(defn home [req]
  (html-response (page
                  ...
                  [:ol.list-decimal.p-5
                   ...
                   [:li "You enter the names of everyone who wants to share the cost."]
                  ...
                  [:p.pb-2 "Let's say Alice, Bob, and Charlie live together in a shared appartment and want to buy a new fridge for 600€."]
                  [:p.pb-2 "Alice offers to pay up to 250€, Bob offers 150€ and Charlie offers 150€."]
